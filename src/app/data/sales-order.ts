export const salesWorkFlows = [
    { id: '74', name: 'Workflow 1' },
    { id: '75', name: 'Workflow 2' },
    { id: '76', name: 'Workflow 3' }
];
export const clients = [
    { id: 'Glo Nigeria', name: 'Glo Nigeria' },
];
...
export const currencies = [
    ...
    { id: 'AWG', name: 'Aruban Florin' }, { id: 'AZN', name: 'Azerbaijani Manat' },
    { id: 'BAM', name: 'Bosnia-Herzegovina Convertible Mark' },
    { id: 'BBD', name: 'Barbadian Dollar' }, { id: 'BDT', name: 'Bangladeshi Taka' },
    { id: 'BGN', name: 'Bulgarian Lev' }, { id: 'BHD', name: 'Bahraini Dinar' },
    { id: 'BIF', name: 'Burundian Franc' }, { id: 'BMD', name: 'Bermudan Dollar' },
    { id: 'BND', name: 'Brunei Dollar' }, { id: 'BOB', name: 'Bolivian Boliviano' },
    { id: 'BRL', name: 'Brazilian Real' }, { id: 'BSD', name: 'Bahamian Dollar' },
    { id: 'BTC', name: 'Bitcoin' }, { id: 'BTN', name: 'Bhutanese Ngultrum' },
    { id: 'BWP', name: 'Botswanan Pula' }, { id: 'BYN', name: 'Belarusian Ruble' },
    { id: 'BZD', name: 'Belize Dollar' }, { id: 'CAD', name: 'Canadian Dollar' },
    { id: 'CDF', name: 'Congolese Franc' }, { id: 'CHF', name: 'Swiss Franc' },
    { id: 'CLF', name: 'Chilean Unit of Account (UF)' }, { id: 'CLP', name: 'Chilean Peso' },
    { id: 'CNH', name: 'Chinese Yuan (Offshore)' },
    ...
    { id: 'LAK', name: 'Laotian Kip' }, { id: 'LBP', name: 'Lebanese Pound' },
    ...
    { id: 'MRO', name: 'Mauritanian Ouguiya (pre-2018)' },
    ...
    { id: 'TOP', name: 'Tongan Paanga' },
    { id: 'TRY', name: 'Turkish Lira' },
    { id: 'TTD', name: 'Trinidadand Tobago Dollar' },
